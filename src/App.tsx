...
function App() {
  ...
  return (
    <div className='bg-primary-950 w-screen h-screen overflow-hidden'>
      {
        !isConnected && <section className="absolute top-0 bottom-0 right-0 left-0">
          <div className="flex justify-center w-full h-screen">
            <img src={vector} alt="vector" className="h-[70%]" />
          </div>
          ...
          <div className="absolute left-0 right-0 bottom-0 top-0">
            <img src={card1} alt="card" className="absolute left-[50%] top-12" />
            <img src={card1} alt="card" className="absolute left-10 top-28" />
            <img src={card2} alt="card" className="absolute right-10 top-28" />
            <img src={card1} alt="card" className="absolute right-20 bottom-28" />
            <img src={card2} alt="card" className="absolute -left-28 bottom-14" />
          </div>
        </section>
      }
